...
const Progress = ({ userData }) => {
  ...
  useEffect(() => {
    ...
    // 🔹 Fetch AI responses for all prompts
    const fetchAllResponses = async () => {
      const dietPlan = await fetchAIResponse("Diet Plan", prompts.diet);
      const workoutPlan = await fetchAIResponse("Workout Plan", prompts.workout);
      const roadmapPlan = await fetchAIResponse("Roadmap", prompts.roadmap);
